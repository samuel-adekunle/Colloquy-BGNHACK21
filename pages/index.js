		...
		<>
			...
			<div className="h-screen bg-gradient-to-r from-blue-500 via-indigo-400 to-blue-50">
				...
				<div className="mx-auto w-min pt-24">
					<iframe style={{ margin: 0, padding: 0, border: "none", width: "500px", height: "700px" }} src="http://localhost:3001/chat/d94bf830-7f90-11eb-ad56-06298c397d52/1615154705991_bb_24" />
				</div>
			</div>
		</>
	);
