...
export default function QuestionCard({ title, questions, answer, remove, add,modifyAnswer, modifyTitle, id }) {
  return (
    <div className="border-4 border-blue-100 rounded-md p-3 bg-blue-50 mt-3">
      <input className="text-2xl pl-2" value={title} name="title" type="text" onChange={(e)=>modifyTitle(id,e.target.value)}/>
